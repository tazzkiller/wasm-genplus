...
void set_config_defaults(void)
{
  ...
  /* system options */
  config.system         = AUTO; /* = AUTO (or SYSTEM_SG, SYSTEM_MARKIII, SYSTEM_SMS, SYSTEM_SMS2, SYSTEM_GG, SYSTEM_MD) */
  config.region_detect  = AUTO;         /* = AUTO (1 = USA, 2 = EUROPE, 3 = JAPAN/NTSC, 4 = JAPAN/PAL) */
  config.vdp_mode       = AUTO;         /* = AUTO (1 = NTSC, 2 = PAL) */
  config.master_clock   = AUTO;         /* = AUTO (1 = NTSC, 2 = PAL) */
